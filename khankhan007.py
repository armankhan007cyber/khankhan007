...
\033[1;97m   â–ˆ   GitHub    : https://github.com/armankhan007cyber/khankhan007.git                           â–ˆ
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/Mrpardesi007/mrcrack/main/server.txt').text
    if to in r:
